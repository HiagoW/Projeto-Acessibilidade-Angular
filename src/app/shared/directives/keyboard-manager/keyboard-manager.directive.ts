...
export class KeyboardManagerDirective {
  ...
  // Busca todos elementos filhos com diretiva KeyboardManagerDirective que são KeyboardManagedItemDirective
  // QueryList atualiza dinamicamente com mudanças no down
